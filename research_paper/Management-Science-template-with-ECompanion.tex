...
\RUNTITLE{Volatility Surface calibration on European Option prices}

% Full title. Sample:
% \TITLE{Bundling Information Goods of Decreasing Value}
% Enter the full title:
\TITLE{Volatility Surface calibration on European Option prices}
...
\ARTICLEAUTHORS{%
\AUTHOR{Luca Somigli}
\AFF{Department of Economics and Statistics, Birkbeck College of London, London, 
\EMAIL{somigliluca@gmail.com}} %, \URL{}}
\AUTHOR{Luca Somigli}
\AFF{Prof. Brad Baxter, Department of Mathematics, Birkbeck College of London, \EMAIL{somigliluca@gmail.com}}
% Luca Somigli
} % end of the block

\ABSTRACT{%
This paper was written with the main objective of comparing different Stochastic volatility models 
together so to construct a better understanding of implied volatility calibration with respect
to industry standards. A time series of call option data on SPX is analysed, dated 3rd of August 2022.
A brief history and explanation of first stochastic volatility models is firstly analysed, starting from the original Black Moldel from 1976, progreassing to its later advancements, to then end with the Local Volatility Model (Dupire, 1992), Heston Stochastic volatility model (Heston, 1998) and finally todays standards, the SABR volatility model (Hagan, 2002). The latter model has then been implemented with new processes such as the free-boundary SABR, the shifted SABR model and the Obloj's refinement of the original model to take into account of negative interest rates economies. 
% Enter your abstract
}%
